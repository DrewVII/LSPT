    ...
    return (
        <div id='goals' className='full-page-section flex items-center justify-between px-8 md:px-16 lg:px-24'>
            <div className='w-full flex flex-col items-center justify-center text-center max-w-2xl mx-auto'>
                ...
                <p className="text-xl md:text-2xl mb-8 font-light py-5">Nous sommes simplement un groupe d&apos;amis qui, un jour, a décidé de changer le cours des choses en donnant à chacun la chance de vivre la liberté que le sport offre.</p>
                <div>
